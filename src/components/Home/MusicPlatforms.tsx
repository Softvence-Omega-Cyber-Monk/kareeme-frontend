  ...
  return (
    <CommonWrapper>
      <div className="flex items-center justify-center p-4">
        <div className="w-full max-w-7xl relative overflow-hidden py-8">
            ...
            {duplicatedPlatforms.map((platform, index) => (
              <div key={index} className="flex-shrink-0 relative group">
                ...
                <div className="flex flex-col items-center gap-2">
                  {/* Icon Container */}
                  <div className=" md:w-20 md:h-20 rounded-xl flex items-center justify-center shadow-lg relative bg-gray-800 overflow-hidden">
                    <img
                      src={platform.icon}
                      alt={platform.name}
