...
const MarketingProcess: React.FC = () => {
  const items = [
    ...
    { icon: Icon4, title: "Strong Audience Engagement", mt: "mt-10" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 w-full relative items-start">
          {items.map((item, index) => (
            <motion.div
              ...
              className=" relative mb-20 flex flex-col  items-center gap-4 min-h-[320px] sm:min-h-[380px] md:min-h-[450px] lg:min-h-[550px] xl:min-h-[650px]"
            >
              <img
                src={item.icon}
              ...
              {index < 3 && (
                <div
                  className="hidden lg:block absolute top-0 right-0 w-[2px] bg-gradient-to-b  from-gray-400/40  via-gray-600/20 
                to-transparent
              "
                  style={{ height: "100%" }}
                ></div>
