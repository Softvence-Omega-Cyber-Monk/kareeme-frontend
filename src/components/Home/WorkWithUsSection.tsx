  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen bg-[#03170F] text-white p-8 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
        ...
        >
          ONEISONEENT CONNECTS CLIENTS WORLDWIDE, EMPOWERING INDEPENDENT ARTISTS AND BRANDS.
        </motion.h1>
        ...
        <motion.button
          ...
          viewport={{ once: true, amount: 0.3 }}
          variants={fadeUp}
          className="flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 text-white font-semibold text-lg rounded-full shadow-lg transition-all duration-300 transform hover:scale-105"
        >
