...
import TIDALOverView from "./TIDALOverView";
    ...
    <div className="w-full  mx-auto">
      ...
      <div className="pt-8">
        ...
        {activeTab === "Assets" && (
          <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-4  gap-5">
            <div className="xl:col-span-4 w-full">
              <TopAssetsDetails platform="TIDAL" period="" />
            </div>
          </div>
        )}
        {activeTab === "Claims" && (
          <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-4  gap-5">
            <div className="xl:col-span-4 w-full">
              <TopClaimsDetails platform="TIDAL" period="" />
            </div>
          </div>
        )}
        {activeTab === "Geo Trends" && (
          <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-4  gap-5">
            <div className="xl:col-span-4 w-full">
              <GeoTrendsDetails platform="TIDAL" period="" />
            </div>
          </div>
        )}
      </div>
